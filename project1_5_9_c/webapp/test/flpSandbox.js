		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product List",
									"targetURL": "#ns59cproject159c-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ns59cproject159c-display": {
								"semanticObject": "ns59cproject159c",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns59c.project159c",
									"url": sap.ui.require.toUrl("ns59c/project159c")
								}
							}
						}
					}
